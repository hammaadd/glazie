                    ...
                    <div class="col-12">
                        <div id="owl-external-color" class="owl-builder owl-carousel owl-theme">
                            ...
                            <li class="item list-unstyled text-center selectable_ext" >
                                ...
                                <button type="button" class="button-door border-0 bg-transparent my-5 w-100" onclick="setprice({{$color->id}},{{$color->price}},1);setcolorimage('{{$color->color_code}}');getdoor();">
      ...
      function setcolorimage(colors)
        {
           // alert(colors);
            ...
            var c = document.getElementById("main_image");
            var mainsvgDoc = c.contentDocument;
