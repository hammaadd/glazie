                    ...
                    <div class="col-12">
                        <div id="owl-letterbox" class="owl-builder owl-carousel owl-theme">
                            ...
                            <li class="item list-unstyled text-center selectable_ext" >
                                ...
                                <button type="button" class="button-door border-0 bg-transparent my-5 w-100"  onclick="setprice({{$letterbox->id}},{{$letterbox->price}},10)">
                                    <div class="door">
                        ...
                        <div class="customNavigation">
                            ...
                            <a class="btn btn-fill-out theme_bgcolor2 text-white px-4 rounded-0 py-2 float-end " onclick="hingedata()">Next</a>
                        </div>
                    </div>
                </div>
            </div>
