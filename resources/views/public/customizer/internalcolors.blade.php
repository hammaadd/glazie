<section class="section product-section">
                ...
                <div class="row">
                    <div class="col-12">
                        <div id="owl-internal-color" class="owl-builder owl-carousel owl-theme">
                            ...
                            <li class="item list-unstyled text-center " onclick="getModalIntColor({{$color->id}}, {{$color->price}})">
                                <input type="hidden" value="internal_color" name="type">
                                <input type="hidden" value="{{$color->id}}" name="int_color_id">
                                <input type="hidden" value="{{$color->price}}" name="int_color_price">
    ...
    function getModalIntColor(id,price){
        total = product_info.total + price;
        product_info['int_color_id'] = id;
        product_info['int_color_price'] = price;
        product_info['total'] = total;
        $('#p_price').html(total);
        console.log(product_info);
    }
    // $(function(){
    //     $('.selectable_int').click(function(){
    //         var type = $('.selectable_int');
