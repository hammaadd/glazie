...
<div class="page-container">
    <div class="main-content">
        <div class="page-header">
            <h2 class="header-title">Add Weight</h2>
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    @endif
                        ...
                        <form action="{{url('admin/weights/store')}}" method="post" id="varieties">
                           
                            <div class="form-group">
                                @csrf
                                
                                <label for="">Minimum Weight (KG) </label>
                                <input type="number" class="form-control" name="min_weight" placeholder="Minimum Weight" id="min_weight" oninput="checkweght()">
                            </div>
                            <div class="form-group">
                          
                                
                                <label for="">Maximum Weight (KG) </label>
                                <input type="number" class="form-control" name="max_weight" placeholder="Maximum  Weight" id="max_weight" oninput="checkweght()">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group mt-3">
                                <button type="submit" class="btn btn-success" id="btn-check"> <i class="fa fa-plus-circle"></i> Add Weight Slot</button>
