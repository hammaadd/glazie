            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endforeach
                        @endif
                        <form action="{{url('admin/addon/store_size/'.$id)}}" method="post" enctype="multipart/form-data" id="addon">
                            @csrf

                            <div class="row">
                                <div class="col-md-12">
                                    <button type="button" class="btn btn-success btn-xs float-right" id="addcolor"><i class="fa fa-plus-circle"></i> Add Size</button>
                                </div>
                            </div>
                            <div class="row">
                               <div class="col-md-12">
...
$(document).ready(function(){
    $('#addcolor').click(function(){
        ...
        row+='</td>';
        row+='<td>';
        row+='<input type="number" class="form-control rounded-0 min="1" name="quantity[]" placeholder="Enter Quantity" required >';
        row+='</td>';
        row+='<td>';
        row+='<input type="number" class="form-control rounded-0 " min="1"  name="price[]" placeholder="Enter price" required >';
        row+='</td>';
        row+='<td>';
