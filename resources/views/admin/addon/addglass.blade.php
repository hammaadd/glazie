...
<div class="page-container">
    <div class="main-content">
        <div class="page-header">
            <h1 class="header-title">Add Glass</h1>
            <div class="header-sub-title float-right">
                <nav class="breadcrumb breadcrumb-dash ">
                    <a href="{{url('admin/dashboard')}}" class="breadcrumb-item"><i class="anticon anticon-home m-r-5"></i>Home</a>
                     <a class="breadcrumb-item" href="{{url('admin/frameglasses/'.$id)}}">Product</a>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endforeach
                        @endif
                        <form action="{{url('admin/createglass')}}" method="post" enctype="multipart/form-data" id="addon">
                            @csrf

                            <div class="row">
                                <div class="col-md-12">
                                    <button type="button" class="btn btn-success btn-xs float-right" id="addcolor"><i class="fa fa-plus-circle"></i> Add  Glass</button>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a class="btn btn-danger ml-1" href="{{url('admin/addon/view/'.$id)}}"><i class="fa fa-times"></i> Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
...
$(document).ready(function(){
    $('#addcolor').click(function(){
       ...
       let row='<div class="card card-primary" id="card-data'+j+'">';
         row+='<div class="card-header bg-primary rounded-2">';
        row+='<h4 style="color:white;" class="mt-2"> Glass Details</h4>';
        row+='</div>';
        ...
        row+='<label for="">Glass Name</label>';
        row+='<input type="text" class="form-control rounded-0" name="glass_name[]" required placeholder="Enter Glass Name">';
        row+='</div>';
        row+='<div class="col-md-3">';
        ...
        row+='<input type="number" class="form-control rounded-0" name="quantity[]" required placeholder="Enter Quantity">';
        row+='</div>';
        row+='<div class="col-md-3">';
