...
@section('title','Update Product variety ')
@section('content')
...
<div class="page-container">
    <div class="main-content">
        <div class="page-header">
            <h2 class="header-title">Update Procut Variety</h2>
            <div class="header-sub-title float-right">
                <nav class="breadcrumb breadcrumb-dash float-right">
                    <a href="{{url('admin/dashboard')}}" class="breadcrumb-item"><i class="anticon anticon-home m-r-5"></i>Home</a>
                    <a class="breadcrumb-item" href="#">Update Variety</a>
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endforeach
                    @endif
                        <form action="{{url('admin/prdvariety/update/'.$variety->id)}}" method="post" id="varieties">
                            <div class="form-group">
                                @csrf
                                <label for="">Variety Name </label>
                                <input type="text" class="form-control" name="prd_name" placeholder="Product Variety Name " value="{{$variety->prd_name}}">
                            </div>
                            <div class="form-group">
                                <button type="submit" class="btn btn-success" > <i class="fa fa-edit"></i> Update Variety</button>
