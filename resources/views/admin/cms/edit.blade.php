                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="title" placeholder="Page Title" autofocus value="{{$cms->title}}" id="title">
                                </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="slug" placeholder="Slug" id="slug" value="{{$cms->slug}}" readonly>
                            </div>
                            <div class="col-md-6">
