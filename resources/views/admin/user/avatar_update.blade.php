            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="avatar avatar-icon avatar-lg">
                                    ...
                                    <img src="{{ asset('user-images/'.$user->avatar)}}">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form action="{{url('admin/user/avatupdate/'.$user->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                <div class="col-md-12">
                                @if(count($errors)>0)
                                    ...
                                    <a href="{{url('admin/user/profile/'.$user->id)}}" class="btn btn-primary mt-3"><i class="fa fa-times"></i> Cancel</a>
                                </form>
                            </div>
                        </div>
