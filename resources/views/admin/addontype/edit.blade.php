...
@section('title','Edit Add On Type ')
@section('content')
...
<div class="page-container">
    <div class="main-content">
        <div class="page-header">
            <h2 class="header-title">Edit Add On Type</h2>
            <div class="header-sub-title">
                <nav class="breadcrumb breadcrumb-dash float-right">
                    <a href="{{url('admin/dashboard')}}" class="breadcrumb-item"><i class="anticon anticon-home m-r-5"></i>Home</a>
                    <a class="breadcrumb-item" href="#">Edit Add On Type</a>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endforeach
                    @endif
                        <form action="{{url('admin/addontype/update/'.$addontype->id)}}" method="post" id="varieties">
                            <div class="form-group">
                                @csrf
                                <label for="">Add On  Name </label>
                                <input type="text" class="form-control" name="name" placeholder="Add On Type Name" value="{{$addontype->name}}">
                            </div>
                            <div class="form-group">
                                <button type="submit" class="btn btn-success" > <i class="anticon anticon-edit"></i> Update AddOn Type</button>
