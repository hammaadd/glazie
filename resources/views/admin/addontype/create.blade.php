            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endforeach
                    @endif
                        <form action="{{url('admin/addontype/store')}}" method="post" id="varieties">
                            <div class="form-group">
                                @csrf
                                <label for="">Add On  Name </label>
                                <input type="text" class="form-control" name="name" placeholder="Add On Type Name">
                            </div>
                            <div class="form-group">
                                <button type="submit" class="btn btn-success" > <i class="fa fa-plus-circle"></i> Add AddOn Type</button>
