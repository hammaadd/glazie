...
@section('title','Change Installer Password')
@section('content')
...
<div class="page-container">
    <div class="main-content">
        <div class="page-header">
            <h2 class="header-title">Change Installer Password</h2>
            <div class="header-sub-title">
                <nav class="breadcrumb breadcrumb-dash">
                    ...
                    <span class="breadcrumb-item" href="#">Change Installer Password </span>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{url('admin/chngeinstallerpwd/'.$id)}}" id="changepass" method="post">
                        @csrf
                            <div class="row">
                                <div class="col-md-12">
