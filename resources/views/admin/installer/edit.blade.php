...
@section('title','Update Installer')
@section('content')
...
<div class="page-container">
    <div class="main-content">
        <div class="page-header">
            <h2 class="header-title">Update Installer</h2>
            <div class="header-sub-title float-right">
                <nav class="breadcrumb breadcrumb-dash">
                    ...
                    <span class="breadcrumb-item" href="#">Update Installer</span>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <form action="{{ url('admin/updateinstaller/'.$user->id)}}"  method="post" id="users" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input class="form-control" type="text" placeholder="Work Experience If Any " name="experience" value="{{$user->installinfo->experience}}">  
                            </div>
                            <div class="col-md-6">
                               <label for="">Recharge</label>
                               <input type="number" class="form-control" name="recharge" placeholder="Recharge " value="{{$user->installinfo->recharge}}">
                            </div>
                        </div>
                        ...
                        <div class="row mt-2">
                            ...
                            <textarea name="skills" id="summernote"class="form-control" cols="30" rows="5">{{$user->installinfo->skills}}</textarea>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-md-6">                                
                                <input  type="checkbox" name="company_info" id="company_info" value="1" @if ($user->company_info=="1")
                                    checked
                                    @php
                                        $div = "";
                                    @endphp
                        ...
                        <div id="company_data" style="display:{{$div}}">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="">Company Name </label>
                                    <input type="text" class="form-control" name="company_name" placeholder="Company Name"  
                                    @isset($user->companies->company_name)
                                    value="{{$user->companies->company_name}}"
                                    @endisset
                                   
                                    >
                                    <input type="hidden" name="company_id"  @isset($user->companies->id)
                                    value="{{$user->companies->id}}"
                                    @endisset>
                                </div>
                                <div class="col-md-6">
                                    <label for="">EmailAddress</label>
                                    <input type="email" class="form-control" name="company_email" placeholder="Company Email Address"   @isset($user->companies->email)
                                    value="{{$user->companies->email}}"
                                    @endisset>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <select name="country_id" id="country_id" class="form-control">
                                        ...
                                        @foreach ($countries as $country)
                                            <option value="{{$country->id}}" 
                                                @isset($user->companies->country_id)
                                            {{-- value="{{$user->companies->id}}" --}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    @isset($user->companies->postcode)
                                    value="{{$user->companies->postcode}}"
                                    @endisset
                                    >
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    @isset($user->companies->contact_no)
                                    value="{{$user->companies->contact_no}}"
                                    @endisset>
                                </div>
                                <div class="col-md-6">
                                    <label for=""> Address</label>
                                    <input type="text" class="form-control" name="address" placeholder="Address" 
                                    @isset($user->companies->address)
                                    value="{{$user->companies->address}}"
                                    @endisset
                                    >
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <textarea name="companydesc" id="company_description"  class="form-control" rows="10">@isset($user->companies->company_description)
                                    {{$user->companies->company_description}}
                                @endisset</textarea>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                            <button type="submit" class="btn btn-success mt-3"><i class="anticon anticon-edit"></i> Update Installer</button>
