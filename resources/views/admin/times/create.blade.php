...
<div class="page-container">
    <div class="main-content">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    <form action="{{ url('/admin/deliverytimes/store')}}"  method="post" enctype="multipart/form-data" id="create_brand">
                    <div class="card-header">
                        <h4 class="card-title">Add Delivery TIme </h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                        @if(count($errors)>0)
                        ...
                        <div class="row">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="Name" autofocus value="{{old('name')}}">
                        ...
                        <div class="row">
                            ...
                            <input type="number" class="form-control" name="time" placeholder="Duration in Days" min="1">
                        </div>
                        
                        <div class="row">
                            <button type="submit" class="btn btn-success mt-3"><i class="fa fa-plus-circle"></i> Create Time </button>
