            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endforeach
                    @endif
                        <form action="{{url('admin/colors/update/'.$colors->id)}}" method="post" id="varieties">
                            <div class="form-group">
                                <label for="">Product</label>
                                <select name="product_id" class="form-control">
                                    @foreach ($products as $product)
                                       <option value="{{$product->id}}"
                                        @if ($product->id==$colors->product_id)
                                            selected
                                        @endif
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" placeholder="Enter Color Name " value="{{$colors->name}}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-success" > <i class="fa fa-edit"></i> Update Color</button>
